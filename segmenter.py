...
def init():
    ...
    if not os.path.exists("saved_models"):
        ...
        hf_hub_download(repo_id="NimaBoscarino/IS-Net_DIS-general-use", filename="isnet-general-use.pth", local_dir="saved_models")
        os.system("rmdir /S /Q git\\xuebinqin\\DIS\\IS-Net\\__pycache__")
        os.system("move git\\xuebinqin\\DIS\\IS-Net\\* .")
